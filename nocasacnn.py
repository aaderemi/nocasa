...
trn_ds = CustomDataset(list(train_idxs), "train_global_mean")
...
bm = main_training_loop(training, validation, 30, device, "cnn_global_unweighted_singlehead", loss, base_model, bs, lr, accum_steps, useauto=False)
